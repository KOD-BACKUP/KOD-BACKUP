...
<body>
    <div class="container">
        ...
        <form  onsubmit="return formCheck(this);" action="join.do" method="post">
         ...
         <div class="input__block" style="padding-left: 27px; ">
            ...
            <!-- 생년월일 입력란 -->
             <div class="input__block" style="padding-left: 27px; ">
                <input type="text" id="year" name="year" placeholder=" ex) 1997 " style=" display: inline-block;  width: 29%;" minlength="4"  maxlength="4" required>
                <select class="box" id="month" name="month" style="width: 29%; display: inline-block; margin-left: 1px;">
                    <script>
                ...
                <input type="text" name="day" placeholder=" ex) 11 " style=" display: inline-block; width: 29%;" minlength="2"  maxlength="2" required>
            </div>


            <!-- 핸드폰번호 입력란 -->
 			<div class="input__block" style="padding-left: 27px; ">
                <input type="text" id="PhNum1" name="PhNum1" placeholder=" 010 " style=" display: inline-block;  width: 26%;" minlength="3"  maxlength="3" required>
                <span style="display: inline-block; margin-left: 5px; margin-right: 5px;">-</span>
                <input type="text" id="PhNum2" name="PhNum2" placeholder=" 0000 " style=" display: inline-block;  width: 26%;" minlength="4"  maxlength="4" required>
                <span style="display: inline-block; margin-left: 5px; margin-right: 5px;">-</span>
                <input type="text" id="PhNum3" name="PhNum3" placeholder=" 0000 " style=" display: inline-block; width: 26%;" minlength="4"  maxlength="4" required>
            </div>
  ...
  function updateDomainTxt() {
	...
	<div class="input__block">
		<input class="input" type="text" name="adrsName" id="adrsName" placeholder="집 / 회사 / 친구" required>
		<input type="text" id="sample4_postcode" name="adrsZipcode" placeholder="우편번호" style="display: inline-block; width: 30%; margin-left: 26px;" required readonly>
		...
		<input type="text" id="sample4_roadAddress" name="adrsStreet" placeholder="도로명주소" required readonly>
		<input type="text" id="sample4_jibunAddress" placeholder="지번주소" name="adrsLotNum" style="margin-top: 5px;" required readonly>
